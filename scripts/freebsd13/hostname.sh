...
if [[ "$PACKER_BUILD_NAME" =~ ^magma-freebsd13-(vmware|hyperv|libvirt|parallels|virtualbox)$ ]]; then
...
elif [[ "$PACKER_BUILD_NAME" =~ ^generic-freebsd13-(vmware|hyperv|libvirt|parallels|virtualbox)$ ]]; then
