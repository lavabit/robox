...
if [[ "$PACKER_BUILD_NAME" =~ ^magma-dragonflybsd-(vmware|hyperv|libvirt|parallels|virtualbox)$ ]]; then
...
elif [[ "$PACKER_BUILD_NAME" =~ ^generic-dragonflybsd-(vmware|hyperv|libvirt|parallels|virtualbox)$ ]]; then
