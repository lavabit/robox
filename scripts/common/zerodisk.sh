...
if [[ "$PACKER_BUILD_NAME" =~ ^(generic|magma)-(freebsd1[1-2]|hardenedbsd1[1-2]|netbsd8|openbsd6|alpine3[5-9]|alpine31[0-1])-(vmware|hyperv|libvirt|parallels|virtualbox)$ ]]; then
