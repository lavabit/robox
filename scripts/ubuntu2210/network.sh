...
if [[ "$PACKER_BUILD_NAME" =~ ^generic-ubuntu2210-(vmware|hyperv|libvirt|parallels|virtualbox)-(x64|x32|a64|a32|p64|p32|m64|m32)$ ]]; then
  printf "ubuntu2210.localdomain\n" > /etc/hostname
  printf "\n127.0.0.1 ubuntu2210.localdomain\n\n" >> /etc/hosts
else
