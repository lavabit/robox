...
if [[ "$PACKER_BUILD_NAME" =~ ^generic-ubuntu1910-(vmware|hyperv|libvirt|parallels|virtualbox)-(x64|x32|a64|a32|p64|p32|m64|m32)$ ]]; then
  printf "ubuntu1910.localdomain\n" > /etc/hostname
  printf "\n127.0.0.1 ubuntu1910.localdomain\n\n" >> /etc/hosts
else
