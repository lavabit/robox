...
function provide-virtmanager() {
  ...
  dnf --assumeyes install virt-manager virt-viewer virt-install virt-manager-common \
    virt-top virt-win-reg gvnc gtk-vnc2 libvirt-glib \
    qemu-kvm-device-display-virtio-gpu qemu-kvm-device-display-virtio-gpu-gl \
    qemu-kvm-device-display-virtio-gpu-pci qemu-kvm-device-display-virtio-gpu-pci-gl \
    qemu-kvm-device-display-virtio-vga qemu-kvm-device-display-virtio-vga-gl \
    qemu-kvm-ui-opengl qemu-kvm-ui-egl-headless \
    qemu-kvm-device-usb-host qemu-kvm-device-usb-redirect
}
...
function provide-setup() {
  ...
  dnf --assumeyes install vim wget curl git lsof gawk jq sysstat vnstat parallel
