...
# url --url=https://mirrors.kernel.org/fedora/releases/32/Everything/x86_64/os/
# url --url=https://archives.fedoraproject.org/pub/archive/fedora/linux/releases/32/Everything/x86_64/os/
