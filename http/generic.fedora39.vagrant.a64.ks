...
#### Prod Repo
url --url=https://dl.fedoraproject.org/pub/fedora/linux/releases/39/Server/aarch64/os/
# url --url=https://mirrors.edge.kernel.org/fedora/releases/39/Everything/aarch64/os/
