...
network --device eth0 --bootproto dhcp --noipv6 --hostname=fedora31.localdomain
...
# url --url=https://archives.fedoraproject.org/pub/archive/fedora/linux/releases/31/Everything/x86_64/os/
