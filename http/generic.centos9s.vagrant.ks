...
volgroup centos9s --pesize=4096 pv.01
logvol swap --fstype="swap" --size=2048 --name=swap --vgname=centos9s
logvol / --fstype="xfs" --percent=100 --label="root" --name=root --vgname=centos9s
