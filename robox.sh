...
ISOSUMS=(`grep -E "iso_checksum|guest_additions_sha256" $FILES | grep -v "iso_checksum_type" | grep -v -E "d2371a6359f18c1f1d69aaf6211569b1f0707ded8286ad7b43a8d64544d1d963|3f961576e9f81ea118566f73f98d7bdf3287671c35436a13787c1ffd5078cf8e|d0dd6ae5e001fb050dafefdfd871e7e648b147fb2d35f0e106e0b34a0163e8f5" | awk -F'"' '{print $4}'`)
...
function localized() {
  verify_local 746586112 d2371a6359f18c1f1d69aaf6211569b1f0707ded8286ad7b43a8d64544d1d963 res/media/ubuntu-18.10-server-amd64.iso http://cdimage.ubuntu.com/ubuntu-server/daily/pending/cosmic-server-amd64.iso
